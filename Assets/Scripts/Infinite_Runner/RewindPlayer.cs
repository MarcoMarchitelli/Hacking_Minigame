...
namespace Rewind
{
    ...
    /// </summary>
    [RequireComponent(typeof(RewindPlayerController))]
    public class RewindPlayer : LivingEntity
    {
        #region Inspector Vars

        public float moveSpeed = 7;
        public RewindGun startingGun;
        ...
        RewindPlayerController controller;
        RewindGun equippedGun;
        ...
        private void Awake()
        {
            controller = GetComponent<RewindPlayerController>();
