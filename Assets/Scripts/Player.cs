...
public class Player : LivingEntity
{
    ...
    /// <summary>
    /// Measured in angle per second.
    /// </summary>
    [Tooltip("Measured in angle per second.")]
    ...
    protected override void Start()
    {
        ...
        controller.SetTurnSpeed(turnSpeed);
    ...
    void Update()
    {
        ...
        //aim input
        Vector3 aimDirection = new Vector3(Input.GetAxisRaw("Right Stick Horizontal"), 0, Input.GetAxisRaw("Right Stick Vertical")).normalized;
